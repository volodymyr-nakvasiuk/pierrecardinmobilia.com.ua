	...
	<div id="column_left">
		...
		<div class="block layer">
			...
			<ul>
				...
				<li><label class=property>Заголовок</label><input name="meta_title" class="admin_inp" type="text" value="{$product->meta_title|escape}" /></li>
				<li><label class=property>Ключевые слова</label><input name="meta_keywords" class="admin_inp" type="text" value="{$product->meta_keywords|escape}" /></li>
				<li><label class=property>Описание</label><textarea name="meta_description" class="admin_inp" />{$product->meta_description|escape}</textarea></li>
			</ul>
		</div>
		...
		<div class="block layer" {if !$categories}style='display:none;'{/if}>
			...
			<ul class="prop_ul">
				{foreach $features as $feature}
					...
					<li feature_id={$feature_id} style='display:none;'><label class=property>{$feature->name}</label><input class="admin_inp" type="text" name=options[{$feature_id}] value="{$options.$feature_id->value|escape}" /></li>
				{/foreach}
			</ul>
			<!-- Новые свойства -->
		...
		<div class="block">
			...
			<ul>
				<li><input id="exp_yad" type="checkbox" /> <label for="exp_yad">Яндекс Маркет</label> Бид <input class="admin_inp" type="" name="" value="12" /> руб.</li>
