...
function CreateTooltip() {
	...
	adminpanel.setAttribute('href', 'admin /');
...
{
  from =  window.location; 
  content = "<p><a href='admin/index.php?module=PageAdmin&id="+object_id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a></p>";
  content += "<p><a href='admin/index.php?section=Sections&action=move_up&item_id="+object_id+"&from="+from+"' class=admin_tooltip_up>Поднять</a></p>";
  content += "<p><a href='admin/index.php?section=Sections&action=move_down&item_id="+object_id+"&from="+from+"' class=admin_tooltip_down>Опустить</a></p>";
  content += "<p><a href='admin/index.php?section=Sections&set_enabled="+object_id+"&from="+from+"' class=admin_tooltip_delete>Скрыть</a></p>";
  ShowTooltip(element, content);
}
