<?php /* Smarty version Smarty-3.0.7, created on 2012-04-30 22:25:22
         compiled from "admin/design/html/page.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1973067274f9ef532c980a4-10699667%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec6bad1b1df72f3e427e1912b48d0f030484689c' => 
    array (
      0 => 'admin/design/html/page.tpl',
      1 => 1335707050,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1973067274f9ef532c980a4-10699667',
  'function' => 
  array (
  ),
...
"/> 
		...
		<div class="block">
			<ul>
				<li><label class=property>Название пункта в меню</label><input name="name" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('page')->value->name);?>
" /></li>
...
" /></li>
				<li><label class=property>Заголовок</label><input name="meta_title" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('page')->value->meta_title);?>
" /></li>
				<li><label class=property>Ключевые слова</label><input name="meta_keywords" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('page')->value->meta_keywords);?>
" /></li>
				<li><label class=property>Описание</label><textarea name="meta_description" class="admin_inp"/><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('page')->value->meta_description);?>
</textarea></li>
			</ul>
		</div>
		<!-- Параметры страницы (The End)-->		
