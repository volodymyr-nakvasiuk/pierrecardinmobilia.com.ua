<?php /* Smarty version Smarty-3.0.7, created on 2012-04-30 02:01:32
         compiled from "admin/design/html/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8980512244f9dd65ce43c60-83202695%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fbe05945946349d0136de77d4802c854b7e78b6f' => 
    array (
  ...
  'nocache_hash' => '8980512244f9dd65ce43c60-83202695',
  'function' => 
  array (
    'category_select' => 
    array (
...
if (!is_callable('smarty_modifier_truncate')) include '/var/www/pcm/data/www/pierrecardinmobilia.com.ua/Smarty/libs/plugins/modifier.truncate.php';
?><?php ob_start(); ?>
...
" /></li>
				<li><label class=property>Заголовок</label><input name="meta_title" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->meta_title);?>
" /></li>
				<li><label class=property>Ключевые слова</label><input name="meta_keywords" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->meta_keywords);?>
" /></li>
				<li><label class=property>Описание</label><textarea name="meta_description" class="admin_inp" /><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('product')->value->meta_description);?>
</textarea></li>
			</ul>
		</div>
...
</label><input class="admin_inp" type="text" name=options[<?php echo $_smarty_tpl->getVariable('feature_id')->value;?>
...
" /></li>
			...
			<ul class=new_features>
				<li id=new_feature><label class=property><input type=text name=new_features_names[]></label><input class="admin_inp" type="text" name=new_features_values[] /></li>
			</ul>
