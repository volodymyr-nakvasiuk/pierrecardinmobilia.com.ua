...
////////////////////////////////////////////////
$order = $admin->orders->get_order(intval($_POST['ik_payment_id']));
if(empty($order))
...
if($_POST['ik_payment_amount'] != round($admin->money->convert($order->total_price, $method->currency_id, false), 2) || $_POST['ik_payment_amount']<=0)
	die("incorrect price");
