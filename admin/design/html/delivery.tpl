...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div id="column_left">
		...
		<div class="block layer">
			...
			<ul>
				<li><label class=property>Стоимость</label><input name="price" class="admin_small_inp" type="text" value="{$delivery->price}" /> {$currency->sign}</li>
				<li><label class=property>Бесплатна от</label><input name="free_from" class="admin_small_inp" type="text" value="{$delivery->free_from}" /> {$currency->sign}</li>
