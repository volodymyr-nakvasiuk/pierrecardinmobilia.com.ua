	...
	<ul class="order_details">
		...
		<li>
			...
			<div class="edit_order_detail" style='display:none;'>
				<input name="name" class="admin_inp" type="text" value="{$order->name|escape}" />
			</div>
		...
		<li>
			...
			<div class="edit_order_detail" style='display:none;'>
				<input name="email" class="admin_inp" type="text" value="{$order->email|escape}" />
			</div>
			<div class="view_order_detail">
		...
		<li>
			...
			<div class="edit_order_detail" style='display:none;'>
				<input name="phone" class="admin_inp" type="text" value="{$order->phone|escape}" />
			</div>
			<div class="view_order_detail">
				{$order->phone|escape}
			</div>
