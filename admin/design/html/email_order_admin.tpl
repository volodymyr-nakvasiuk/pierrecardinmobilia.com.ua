...
<h1 style="font-weight:normal;font-family:arial;">
	<a href="{$config->root_url}/admin/index.php?module=OrderAdmin&id={$order->id}">Заказ №{$order->id}</a>
...
<table cellpadding="6" cellspacing="0" style="border-collapse: collapse;">
	...
	<tr>
		...
		<td style="padding:6px; width:330; background-color:#ffffff; border:1px solid #e0e0e0;font-family:arial;">
			{$order->name|escape}
			{if $user}(<a href="{$config->root_url}/admin/index.php?module=UserAdmin&id={$user->id}">зарегистрированный пользователь</a>){/if}
		</td>
	</tr>
	{/if}
	{if $order->email}
