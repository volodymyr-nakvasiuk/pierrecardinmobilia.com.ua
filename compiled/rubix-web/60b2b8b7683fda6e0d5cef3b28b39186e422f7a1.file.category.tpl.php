<?php /* Smarty version Smarty-3.0.7, created on 2012-04-30 01:58:57
         compiled from "admin/design/html/category.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15481921754f9dd5c1041782-96849209%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '60b2b8b7683fda6e0d5cef3b28b39186e422f7a1' => 
    array (
  ...
  'nocache_hash' => '15481921754f9dd5c1041782-96849209',
  'function' => 
  array (
    'category_select' => 
    array (
...
" /></li>
				<li><label class=property>Заголовок</label><input name="meta_title" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('category')->value->meta_title);?>
" /></li>
				<li><label class=property>Ключевые слова</label><input name="meta_keywords" class="admin_inp" type="text" value="<?php echo smarty_modifier_escape($_smarty_tpl->getVariable('category')->value->meta_keywords);?>
" /></li>
				<li><label class=property>Описание</label><textarea name="meta_description" class="admin_inp" /><?php echo smarty_modifier_escape($_smarty_tpl->getVariable('category')->value->meta_description);?>
</textarea></li>
			</ul>
		</div>
